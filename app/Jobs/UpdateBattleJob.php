...
class UpdateBattleJob implements ShouldQueue
{
    ...
    {
        Log::channel('log_api')->info('Update Battle Job: '.json_encode($data));
        $this->data = $data;
    }
    ...
    public function handle()
    {
        ...
        $url = config('constants.NFT.END_POINT') . '/api/v1/battle/update?' . $query_str;
