    ...
    */
    ...
    'connections' => [
        ...
        'gameG36' => [
            ...
            'port' => env('DB_PORT', '3306'),
            'database' => 'dson_g36',
            'username' => env('DB_USERNAME_DEV_GAME', 'forge'),
            'password' => env('DB_PASSWORD_DEV_GAME', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
        ...
        'gamemain' => [
            ...
            'password' => env('DB_PASSWORD_GAME_MAIN', ''),
            'unix_socket' => env('DB_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
    ...
    */
    ...
    'redis' => [
        ...
        'options' => [
            ...
            'prefix' => env('REDIS_PREFIX', Str::slug(env('APP_NAME', 'tankbattle'), '_').'_database_'),
        ],

        'default' => [
            'url' => env('REDIS_URL'),
            'host' => env('REDIS_HOST', 'local.db'),
