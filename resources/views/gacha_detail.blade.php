        ...
        <div class="col-12">
            <div class="table-1">
                <div class="title-wrapper">
                    <p class="gacha-detail-title">Type probability</p>
                </div>
                <table>
                    <tr>
                        <td class="primary-color">SSR Warrior</td>
                        <td>5%</td>
                    </tr>
                    <tr>
                        <td class="secondary-color">Warrior SR</td>
                        <td>25%</td>
                    </tr>
                    <tr>
                        <td class="third-color">Combatant R</td>
                        <td>70%</td>
                    </tr>
                </table>
            </div>
            <div class="table-2">
                <div class="title-wrapper">
                    <p class="gacha-detail-title">Limited recruitment</p>
                </div>
